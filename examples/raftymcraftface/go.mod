...
require (
	...
	sylr.dev/rafty/discovery/consul v0.0.0
...
require (
	...
	sylr.dev/rafty/distributor/consistent v0.0.0 // indirect
)
...
replace (
	...
	sylr.dev/rafty/distributor/consistent => ../../distributor/consistent
